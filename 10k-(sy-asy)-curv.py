...
output_dir = r"E:\PG After24-9\论文\冉宇-C7倾斜角\数据处理\spine公开代码及数据备用\Table 1"  # Add root path for E drive (original code missed E:)
output_file = os.path.join(output_dir, "10k-(sy-asy)-curv.xlsx")  # Modify file name
