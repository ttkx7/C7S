...
# 读取Excel文件
input_file = r"E:\PG After24-9\论文\冉宇-C7倾斜角\数据处理\1万人的基线和数据-武灵敏+-+副本.xlsx"
output_dir = r"E:\PG After24-9\论文\冉宇-C7倾斜角\数据处理"
os.makedirs(output_dir, exist_ok=True)
output_file = os.path.join(output_dir, "男性有症状10年龄段颈椎曲度C7S.xlsx")
...
# 筛选疾病分型为有症状且性别为男的数据
symptomatic_data = data[(data["疾病分型"] == 1) & (data["性别"] == 0)]
